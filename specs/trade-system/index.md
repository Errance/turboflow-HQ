...
- [reports/2026-05-15-keeper-refactor-investigation.md](reports/2026-05-15-keeper-refactor-investigation.md): refactor investigation for keeper core and perpetual DEX upgrade, including symptom examples, architectural priorities, migration cost, and decomposed roadmap.
- [plans/2026-05-15-keeper-role-based-extraction-durable-commands.md](plans/2026-05-15-keeper-role-based-extraction-durable-commands.md): selected migration plan for role-based keeper extraction with durable commands, leases, idempotency, shadow mode, and staged worker rollout.
